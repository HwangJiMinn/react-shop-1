...
export const loader = async () => {
  const digital = await fetch('https://fakestoreapi.com/products//category/electronics');
  ...
  const products: Product[] = await digital.json();
  ...
  return (
    <section className="mx-auto p-4">
      ...
      <article className="mx-auto mb-20 px-4 pt-2 pb-4">
        <ItemList title="디지털" limit={12} data={products} />
      </article>
    </section>
  );
};
